...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        self.input_placeholder = tf.placeholder(tf.float32, [batch_size, self.config.n_features])
        self.labels_placeholder = tf.placeholder(tf.int32, [batch_size, self.config.n_classes])
        ### END YOUR CODE
