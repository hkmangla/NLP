...
class ParserModel(Model):
    ...
    def add_embedding(self):
        ...
        lookup_emb = tf.nn.embedding_lookup(emb,self.input_placeholder)
        
        embeddings = tf.reshape(lookup_emb,[-1,self.config.n_features*self.config.embed_size])
        ### END YOUR CODE
        return embeddings
    ...
    def add_prediction_op(self):
        ...
        with tf.variable_scope("parse") as pp:
